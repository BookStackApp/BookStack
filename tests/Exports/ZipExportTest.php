...
class ZipExportTest extends TestCase
{
    ...
    public function test_book_export()
    {
        ...
        $this->assertEquals($book->contents()->getDescriptionHtml(), $bookData['description_html']);
    ...
    public function test_chapter_export()
    {
        ...
        $this->assertEquals($chapter->contents()->getDescriptionHtml(), $chapterData['description_html']);
