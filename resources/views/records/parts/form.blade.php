...
<div class="form-group collapsible" component="collapsible" id="logo-control">
    ...
    <div refs="collapsible@content" class="collapse-content">
        ...
        @include('form.image-picker', [
            ...
            'currentImage' => (isset($model) && $model->cover) ? $model->getRecordCover() : url('/book_default_cover.png') ,
            'name' => 'image',
            'imageClass' => 'cover'
        ])
    </div>
...
<div class="form-group collapsible" component="collapsible" id="tags-control">
    <button refs="collapsible@trigger" type="button" class="collapse-title text-link" aria-expanded="false">
        <label for="tag-manager">{{ trans('entities.record_tags') }}</label>
    </button>
    <div refs="collapsible@content" class="collapse-content">
        @include('entities.tag-manager', ['entity' => $record ?? null])
    </div>
</div>
...
<div class="form-group collapsible" component="collapsible" id="template-control">
    ...
    <div refs="collapsible@content" class="collapse-content">
        @include('entities.template-selector', ['entity' => $record ?? null])
    </div>
</div>

<div class="form-group text-right">
    <a href="{{ $returnLocation }}" class="button outline">{{ trans('common.cancel') }}</a>
    <button type="submit" class="button">{{ trans('entities.records_save') }}</button>
</div>
