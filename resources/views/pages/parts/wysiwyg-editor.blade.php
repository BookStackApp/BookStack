    ...
    <div class="row fieldGroup">
      <div class="col-md-10  ">
        <div class="form-group">
          ...
          <input type="text" name="sectionTitle[]" id="sectionTitle" class="form-control" value="{{$page->page_sub_title}}">
        </div>
      </div>
      <!-- <div class="col-md-2  ">
      ...
      <div class="col-md-12  ">
        <div class="form-group">
          ...
          <textarea name="sectionContent[]" class="editor" rows="5" placeholder="descriptions">{{$page->page_description}}</textarea>
        </div>
      </div>
    </div>
    @endforeach
