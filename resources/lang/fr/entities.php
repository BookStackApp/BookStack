...
return [
    ...
    'pages_editor_switch_title' => 'Changer l\'éditeur',
    'pages_editor_switch_are_you_sure' => 'Voulez-vous vraiment changer l\'éditeur de cette page ?',
    'pages_editor_switch_consider_following' => 'Tenez compte des éléments suivants lorsque vous changez d\'éditeur :',
    'pages_editor_switch_consideration_a' => 'Une fois enregistrée, la nouvelle option d\'éditeur sera utilisée par tous les futurs éditeurs, y compris ceux qui pourraient ne pas être en mesure de modifier eux-mêmes le type d\'éditeur.',
    'pages_editor_switch_consideration_b' => 'Cela peut potentiellement conduire à une perte de syntaxe dans certaines circonstances.',
    'pages_editor_switch_consideration_c' => 'Les modifications apportées aux balises ou au journal des changements depuis le dernier enregistrement ne persisteront pas après cette modification.',
