...
return [
    ...
    'gte'                  => [
        'numeric' => ':attribute musi być większy od lub równy :value.',
        'file'    => ':attribute musi być większy od lub równy :value kilobajtów.',
        'string'  => 'Długość :attribute musi być większa od lub równa :value znaków.',
        'array'   => ':attribute musi mieć :value lub więcej elementów.',
    ],
    'exists'               => 'Wybrana wartość :attribute jest nieprawidłowa.',
    'image'                => ':attribute musi być obrazkiem.',
    'image_extension'      => ':attribute musi mieć poprawne i obsługiwane rozszerzenie obrazu.',
    ...
    'lte'                  => [
        'numeric' => ':attribute musi być mniejszy od lub równy :value.',
        'file'    => ':attribute musi być mniejszy od lub równy :value kilobajtów.',
        'string'  => 'Długość :attribute musi być mniejsza od lub równa :value znaków.',
    ...
    'no_double_extension'  => ':attribute musi mieć tylko jedno rozszerzenie pliku.',
    ...
    'uploaded'             => 'Plik nie mógł zostać przesłany. Serwer może nie akceptować plików o takim rozmiarze.',
