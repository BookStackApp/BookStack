...
return [
    ...
    'maint_recycle_bin_desc' => '被删除的书架、书籍、章节和页面会被存入回收站，你可以还原或永久删除它们。回收站中较旧的项目可能会在系统设置的一段时间后被自动删除。',
    ...
    'users_migrate_ownership_desc' => '如果你想要当前用户拥有的全部项目转移到另一个用户（更改拥有者），请在此处选择一个用户。',
