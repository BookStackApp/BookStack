...
return [
    ...
    'recycle_bin_restore_deleted_parent' => 'O parente deste item também foi eliminado. Estes permanecerão eliminados até que o parente seja também restaurado.',
    'recycle_bin_destroy_notification' => 'Eliminados no total :count itens da lixeira.',
    'recycle_bin_restore_notification' => 'Restaurados no total :count itens da lixeira.',

    // Audit Log
    'audit' => 'Registro de auditoria',
    'audit_desc' => 'Este registro de auditoria exibe uma lista de atividades rastreadas no sistema. Esta lista não é filtrada ao contrário de listas de atividades similares no sistema onde filtros de permissão são aplicados.',
