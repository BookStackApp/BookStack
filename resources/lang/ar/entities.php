...
return [
    ...
    'shelves_add_books' => 'اضف الكتب لهذا الرف',
    'shelves_drag_books' => 'اسحب الكتب لإضافتها لهذا الرف',
    'shelves_empty_contents' => 'لا يوجد اي كتب في هذا الرف',
    ...
    'shelves_delete_explain' => "ستم حذف الرف  ':name'. لن يتم حذف الكتب في هذا الرف.",
    ...
    'shelves_copy_permissions_to_books' => 'نسخ الصلاحيات للكتب',
    'shelves_copy_permissions' => 'نسخ الصلاحيات',
    'shelves_copy_permissions_explain' => 'سيتم تطبيق الصلاحيات على كل الكتب في هذا الرف. قبل التفعيل تأكد من الصلاحيات لهذا الرف.',
    'shelves_copy_permission_success' => 'تم نسخ صلاحية الرف ل :count كتاب/كتب',
