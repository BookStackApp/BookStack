...
return [
    ...
    'saml_already_logged_in' => 'Вход в систему произведен ранее',
    'saml_user_not_registered' => 'Пользователь :name не зарегистрирован и автоматическая регистрация отключена.',
    'saml_no_email_address' => 'Не удалось найти адрес электронной почты этого пользователя в данных, предоставленных внешней системой аутентификации',
    ...
    'saml_fail_authed' => 'Вход используя :system завершился неудачей, так как система не предоставила успешную авторизацию.',
    'saml_email_exists' => 'Регистрация не удалась, так как уже есть пользователь с адресом электронной почты \':email\'',
    ...
    // System
    'path_not_writable' => 'Невозможно загрузить файл по пути \':filePath\'. Убедитесь что папка доступна для записи.',
    ...
    'server_upload_limit' => 'Сервер не позволяет загружать файлы такого размера. Необходмо уменьшить размер загружаемого файла.',
    'uploaded'  => 'Сервер не позволяет загружать файлы такого размера. Необходимо уменьшить размер загружаемого файла.',
    ...
    'role_cannot_remove_only_admin' => 'Это единственный пользователь с правами администратора. Назначьте роль администратора другому пользователю, прежде чем удалить этого.',
