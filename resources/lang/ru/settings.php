...
return [
    ...
    'app_secure_images_desc' => 'Для лучшей производительности все изображения являются общедоступными. Этот параметр добавляет случайную строку перед URL изображения. Для предотвращения легкого доступа, убедитесь, что индексация каталогов отключена.',
    ...
    'content_colors_desc' => 'Устанавливает цвета для всех элементов в иерархии организации страницы. <br>Для удобства чтения рекомендуется выбирать цвета с яркостью, аналогичной цветам по умолчанию.',
    'bookshelf_color' => 'Полки',
    'book_color' => 'Книги',
    'chapter_color' => 'Главы',
    'page_color' => 'Страницы',
    'page_draft_color' => 'Черновики',
    ...
    'reg_enable_ldap_warning' => 'Опция выше не используется, когда активна аутентификация LDAP. Учетные записи пользователей для несуществующих участников будут создаваться автоматически, если аутентификация на основе используемой системы LDAP прошла успешно.',
