...
return [
    ...
    'permissions_intro' => 'После включения опции, эти разрешения будут иметь приоритет над любыми установленными полномочиями.',
    ...
    'shelves_popular_empty' => 'Здесь появятся популярные полки.',
    'shelves_new_empty' => 'Здесь появятся последние созданные полки.',
    'shelves_save' => 'Сохранить полку',
    'shelves_books' => 'Книги из этой полки',
    'shelves_add_books' => 'Добавить книгу в эту полку',
    'shelves_drag_books' => 'Вы можете перетаскивать книги справа для добавления их на эту полку',
    ...
    'shelves_permissions_active' => 'Доступы к полке активны',
    ...
    'shelves_copy_permission_success' => 'Доступы полки скопированы для :count books',
    ...
    'chapters_delete_explain' => 'Это удалит главу с именем \':chapterName\'. Все страницы главы будут перемещены в текущую книгу.',
    ...
    'pages_editing_draft_notification' => 'В настоящее время вы редактируете черновик, который был сохранен :timeDiff.',
    ...
    'tags_explain' => "Добавьте теги, чтобы лучше классифицировать ваш контент. \n Вы можете присвоить значение тегам для более глубокой организации.",
    'tags_add' => 'Добавить тег',
    'tags_remove' => 'Удалить этот тэг',
    'attachments' => 'Вложения',
    'attachments_explain' => 'Загрузите несколько файлов или добавьте ссылку для отображения на своей странице. Вложения видны на боковой панели страницы.',
    ...
    'attachments_deleted' => 'Файл успешно удален',
    ...
    'templates' => 'Шаблоны',
    'templates_set_as_template' => 'Назначить страницу шаблоном',
