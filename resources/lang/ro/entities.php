...
return [
    ...
    'shelves_edit_named' => 'Editează raft de cărți :name',
    'shelves_edit' => 'Editează raft de cărți',
    'shelves_delete' => 'Șterge raft',
    'shelves_delete_named' => 'Șterge raftul :name',
    'shelves_delete_explain' => "Acest lucru va șterge raftul cu numele ':name'. Cărțile conținute nu vor fi șterse.",
    'shelves_delete_confirmation' => 'Ești sigur că vrei să ștergi acest raft de cărți?',
    ...
    'shelves_permissions_cascade_warning' => 'Permisiunile de pe rafturi nu se aplică automat către cărțile conținute. Aceasta se datorează faptului că o carte poate exista pe mai multe rafturi. Cu toate acestea, drepturile pot fi copiate în cărți copii, utilizând opțiunea găsită mai jos.',
    'shelves_copy_permissions_to_books' => 'Copiază permisiunile către cărți',
    'shelves_copy_permissions' => 'Copiază permisiunile',
    'shelves_copy_permissions_explain' => 'Aceasta va aplica setările de permisiune curente pentru acest raft la toate cărțile conținute în interior. Înainte de activare, asigură-te că modificările aduse permisiunilor acestui raft au fost salvate.',
    'shelves_copy_permission_success' => 'Permisiuni raft copiate în :count cărți',
