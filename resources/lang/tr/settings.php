...
return [
    ...
    'app_secure_images_toggle' => 'Daha yüksek güvenlikli görsel yüklemelerine izin ver',
    'app_secure_images_desc' => 'Performans sebepleri nedeniyle bütün görseller halka açık. Bu opsiyon rastgele ve tahmin edilmesi zor dizileri görsel linklerinin önüne ekler. Dizin indekslerinin kapalı olduğundan emin olun.',
    ...
    'app_custom_html_desc' => 'Buraya eklenecek olan içerik her sayfanın <head> etiketinin en sonuna eklenecektir. Bu, stillerin üstüne yazarken veya analytics kodu eklerken faydalı bir kullanım şeklidir.',
    ...
    'app_homepage_desc' => 'Varsayılan görünüm yerine ana sayfada görünmesi için bir görünüm seçin. Sayfa izinleri seçili sayfalar için yok sayılacaktır.',
    ...
    'reg_confirm_restrict_domain_desc' => 'Kısıtlamak istediğiniz email alan adlarını virgül ile ayırarak yazınız. Kullanıcılara uygulamaya erişmeden önce adreslerini doğrulamak için bir mail gönderilecektir. <br> Kullanıcılar başarıyla kaydolduktan sonra email adreslerini değiştiremezler.',
