...
return [
    ...
    'permissions_intro' => 'Μόλις ενεργοποιηθούν, αυτά τα δικαιώματα θα έχουν προτεραιότητα έναντι οποιωνδήποτε αδειών (δικαιωμάτων) που εκχωρούνται από καθορισμένους ρόλους.',
    'permissions_enable' => 'Ενεργοποιήση προσαρμοσμένων δικαιωμάτων',
