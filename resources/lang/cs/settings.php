...
return [
    ...
    'users_api_tokens_none' => 'Pro tohoto uživatele nebyly vytvořeny žádné API tokeny',
    ...
    'user_api_token_update_success' => 'API Token úspěšně aktualizován',
    ...
    'user_api_token_delete_warning' => 'Tímto plně smažete tento API token s názvem \':tokenName\' ze systému.',
    'user_api_token_delete_confirm' => 'Opravdu chcete odstranit tento API token?',
    'user_api_token_delete_success' => 'API Token úspěšně odstraněn',
