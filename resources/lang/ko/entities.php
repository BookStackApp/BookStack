...
return [
    ...
    'shelves_permissions_cascade_warning' => '책은 여러 책꽂이에 들어갈 수 있으므로 책 권한은 책꽂이 권한과 분리되어 있습니다. 아래 옵션으로 책꽂이 권한을 책에 복사할 수 있습니다.',
    ...
    'tags_remove' => '태그 삭제',
    'tags_usages' => '모든 태그',
    'tags_assigned_pages' => '문서에 태그 지정함',
    'tags_assigned_chapters' => '챕터에 태그 지정함',
    'tags_assigned_books' => '책에 태그 지정함',
    'tags_assigned_shelves' => '책꽂이에 태그 지정함',
    'tags_x_unique_values' => ':count 중복 없는 값',
    'tags_all_values' => '모든 값',
    'tags_view_tags' => '태그 보기',
    'tags_view_existing_tags' => '존재하는 태그 보기',
