...
return [
    ...
    'shelves_drag_books' => '여기에 책자을 드롭하세요.',
    'shelves_empty_contents' => '이 서가에 책자이 없습니다.',
    'shelves_edit_and_assign' => '서가 바꾸기로 책자을 추가하세요.',
    'shelves_edit_named' => ':name 바꾸기',
    'shelves_edit' => '서가 바꾸기',
    'shelves_delete' => '서가 지우기',
    'shelves_delete_named' => ':name 지우기',
    'shelves_delete_explain' => ':name을 지웁니다. 책자은 지우지 않습니다.',
    ...
    'books_delete_explain' => ':bookName에 있는 모든 챕터과 문서도 지웁니다.',
    'books_delete_confirmation' => '이 책자을 지울 건가요?',
    'books_edit' => '책자 바꾸기',
    ...
    'books_empty_contents' => '이 책자에 챕터이나 문서가 없습니다.',
    ...
    'chapters_delete_confirm' => '이 챕터을 지울 건가요?',
