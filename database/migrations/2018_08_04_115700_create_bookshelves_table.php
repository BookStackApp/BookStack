...
class CreateBookshelvesTable extends Migration
{
    ...
    public function down()
    {
        ...
        DB::table('activities')->where('entity_type', '=', \BookStack\Entities\Bookshelf::class)->delete();
        DB::table('views')->where('viewable_type', '=', \BookStack\Entities\Bookshelf::class)->delete();
        DB::table('entity_permissions')->where('restrictable_type', '=', \BookStack\Entities\Bookshelf::class)->delete();
        DB::table('tags')->where('entity_type', '=', \BookStack\Entities\Bookshelf::class)->delete();
        DB::table('search_terms')->where('entity_type', '=', \BookStack\Entities\Bookshelf::class)->delete();
        DB::table('comments')->where('entity_type', '=', \BookStack\Entities\Bookshelf::class)->delete();
    }
}
