...
return [
    ...
    'ldap' => [
        ...
        'group_style'            => env('LDAP_GROUP_STYLE', 'RFC2307bis'),
        'group_base_dn'          => env('LDAP_GROUP_BASE_DN', false),
        'group_member_attribute' => env('LDAP_GROUP_MEMBER_ATTRIBUTE', 'memberUid'),
        'group_filter'           => env('LDAP_GROUP_FILTER', '(&(objectClass=posixGroup))'),
