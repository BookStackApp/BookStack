...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'users' => \BookStack\GraphQL\Queries\UsersQuery::class,
                'books' => \BookStack\GraphQL\Queries\BooksQuery::class,
                'bookshelves' => \BookStack\GraphQL\Queries\BookshelvesQuery::class,
            ],
            'mutation' => [
