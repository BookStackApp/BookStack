 ...
 * @property RecordChapter $chapter
 * @property Collection   $attachments
 * @property Collection   $revisions
 * @property PageRevision $currentRevision
 */
class RecordPage extends RecordChild
{
    use HasFactory;
    ...
    {
        return $this->belongsTo(RecordChapter::class);
    }
    ...
    {
        return $this->hasOne(RecordPageRevision::class)
            ->where('type', '=', 'version')
            ->orderBy('created_at', 'desc')
            ->orderBy('id', 'desc');
    }
    ...
    {
        return $this->hasMany(RecordPageRevision::class);
    }
    ...
    public function forJsonDisplay(): self
    {
        ...
        // Convert to Page model before passing to PageContent
        $page = RecordPage::find($refreshed->id);
        $refreshed->html = (new PageContent($page))->render();
    ...
    {
        return $this->belongsTo(RecordChapter::class, 'record_chapter_id');
    }
}
