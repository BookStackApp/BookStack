...
return [
    ...
    'interface' => 'Preferenze dell\'interfaccia',
    'interface_desc' => 'Qui puoi trovare le opzioni per personalizzare l\'aspetto dell\'interfaccia utente dell\'applicazione.',
    'interface_display_mode' => 'Modalità di visualizzazione',
    'interface_display_mode_desc' => 'Scegli se l\'applicazione deve essere visualizzata in modalità scura o chiara. È possibile cambiare questa impostazione anche dalla schermata iniziale o tramite il menu a tendina del profilo nella barra di intestazione.',
    'layouts' => 'Preferenze di scelta rapida dell\'Interfaccia Utente',
    'layouts_desc' => 'Personalizza la disposizione delle sezioni visualizzate nell\'interfaccia utente per una serie di visualizzazioni.',
    'layout_edit' => 'Modifica il Layout',
    'layout_edit_desc' => 'Trascina e rilascia le sezioni oppure utilizza il menu delle azioni presente su ciascuna di esse per ridefinire quali sezioni visualizzare all\'interno di questo layout nell\'interfaccia e dove visualizzarle.',
    'layout_edit_column_hint' => 'Se visualizzate su schermi di dimensioni ridotte, le sezioni della colonna di destra verranno sovrapposte a quelle della colonna di sinistra.',
    'layout_edit_save' => 'Salva Layout',
    'layout_edit_layouts' => 'Layouts',
    'layout_edit_back_to_preferences' => 'Torna alle Preferenze',
    'layout_edit_left' => 'Sinistra',
    'layout_edit_right' => 'Destra',
    'layout_edit_center' => 'Centro',
    'layout_edit_unused' => 'Non utilizzato',
    'layout_edit_empty' => 'Nessuna sezione da visualizzare',
    'layout_edit_reset_to_defaults' => 'Ripristina predefinito',
    'layout_update_success' => 'Le preferenze di layout sono state aggiornate!',
    'layout_reset_success' => 'Le preferenze di layout sono state aggiornate!',
