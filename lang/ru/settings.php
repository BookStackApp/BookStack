...
return [
    ...
    'sort_rule_operations_desc' => 'Настройте сортировку, выбрав операции из списка доступных. Операции будут применяться сверху вниз. Изменения затронут все связанные книги!',
