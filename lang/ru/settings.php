...
return [
    ...
    'sorting_rules_desc' => 'Предопределенные операции сортировки, которые могут быть применены к книгам',
    'sort_rule_assigned_to_x_books' => 'Используется в :count книгах',
    'sort_rule_create' => 'Создать правило',
    'sort_rule_edit' => 'Редактировать правило',
    'sort_rule_delete' => 'Удалить правило',
    'sort_rule_delete_desc' => 'Удалите правило сортировки. Книги, использующие это правило, вернутся к ручной сортировке.',
    'sort_rule_delete_warn_books' => 'Это правило сортировки используется в :count книгах. Вы уверены, что хотите удалить его?',
    ...
    'sort_rule_details_desc' => 'Название для правила сортировки, которое будет отображаться при выборе сортировки пользователями.',
    'sort_rule_operations' => 'Операции сортировки',
    'sort_rule_operations_desc' => 'Настройте сортировку, перемещая операции из списка доступных. При использовании операции будут применяться в порядке сверху вниз. Изменения будут применены ко всем связанным книгам!',
    'sort_rule_available_operations' => 'Доступные операции',
    'sort_rule_available_operations_empty' => 'Нет доступных операций',
    'sort_rule_configured_operations' => 'Настроенные операции',
    'sort_rule_configured_operations_empty' => 'Добавьте операции из списка "Доступные операции"',
    'sort_rule_op_asc' => '(По возрастанию)',
    'sort_rule_op_desc' => '(По убыванию)',
    'sort_rule_op_name' => 'По алфавиту',
    'sort_rule_op_name_numeric' => 'По нумерации',
    'sort_rule_op_created_date' => 'Дата создания',
    'sort_rule_op_updated_date' => 'Дата обновления',
