...
return [
    ...
    'watch_desc_ignore' => '忽略所有通知，包括来自用户级首选项的通知。',
    'watch_title_new' => '新页面',
    'watch_desc_new' => '在此项目中创建任何新页面时发出通知。',
    ...
    'watch_detail_parent_chapter' => '继承自父章节的关注',
    'watch_detail_parent_chapter_ignore' => '继承自父章节的忽略',
];
