...
return [
    ...
    'interface' => 'Oberflächeneinstellungen',
    'interface_desc' => 'Hier können Sie das Erscheinungsbild der Benutzeroberfläche anpassen.',
    'interface_display_mode' => 'Anzeigemodus',
    'interface_display_mode_desc' => 'Wählen Sie, ob die Anwendung im dunklen oder hellen Modus angezeigt werden soll. Dies kann auch in der Startansicht oder über das Profil-Dropdown in der Kopfleiste geändert werden.',
    'layouts' => 'Layout-Einstellungen',
    'layouts_desc' => 'Passen Sie das Layout der in der Benutzeroberfläche angezeigten Bereiche für verschiedene Ansichten an.',
    'layout_edit' => 'Layout bearbeiten',
    'layout_edit_desc' => 'Ziehen Sie Bereiche per Drag-and-drop oder verwenden Sie das Aktionsmenü des jeweiligen Bereichs, um festzulegen, welche Bereiche in diesem Layout angezeigt werden und wo sie in der Benutzeroberfläche platziert sind.',
    'layout_edit_column_hint' => 'Bei kleineren Bildschirmgrößen werden die Bereiche in der rechten Spalte über den Bereichen in der linken Spalte angeordnet.',
    'layout_edit_save' => 'Layout speichern',
    'layout_edit_layouts' => 'Layouts',
    'layout_edit_back_to_preferences' => 'Zurück zu den Einstellungen',
    'layout_edit_left' => 'Links',
    'layout_edit_right' => 'Rechts',
    'layout_edit_center' => 'Mitte',
    'layout_edit_unused' => 'Nicht verwendet',
    'layout_edit_empty' => 'Keine Bereiche zum Anzeigen',
    'layout_edit_reset_to_defaults' => 'Auf Standard zurücksetzen',
    'layout_update_success' => 'Die Layout-Einstellungen wurden aktualisiert!',
    'layout_reset_success' => 'Die Layout-Einstellungen wurden zurückgesetzt!',
