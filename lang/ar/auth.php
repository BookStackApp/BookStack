...
return [
    ...
    'mfa_option_totp_desc' => 'لاستخدام المصادقة المتعددة العوامل، ستحتاج إلى تطبيق محمول يدعم كلمة السر لمرة واحدة المستندة إلى الوقت مثل Google Authenticator أو Authy أو Microsoft Authenticer.',
