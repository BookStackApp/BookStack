...
return [
    ...
    // Books
    'book_create'                 => 'が中分類を作成:',
    'book_create_notification'    => '中分類を作成しました',
    'book_create_from_chapter'              => 'がチャプターを中分類に変換:',
    'book_create_from_chapter_notification' => 'チャプターを中分類に変換しました',
    'book_update'                 => 'が中分類を更新:',
    'book_update_notification'    => '中分類を更新しました',
    'book_delete'                 => 'が中分類を削除:',
    'book_delete_notification'    => '中分類を削除しました',
    'book_sort'                   => 'が中分類の並び順を変更:',
    'book_sort_notification'      => '中分類が再度並び変えられました',

    // Bookshelves
    'bookshelf_create'            => 'が大分類を作成:',
    'bookshelf_create_notification'    => '大分類を作成しました',
    'bookshelf_create_from_book'    => 'が中分類を大分類に変換:',
    'bookshelf_create_from_book_notification'    => '中分類を大分類に変換しました',
