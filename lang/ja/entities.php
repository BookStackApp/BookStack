...
return [
    ...
    'recently_created_books' => '最近作成された中分類',
    'recently_created_shelves' => '最近作成された大分類',
    ...
    'permissions_book_cascade' => '中分類に設定された権限は、子チャプターや子ページに独自の権限が定義されていない限り、自動的に子チャプターや子ページに継承されます。',
    ...
    'shelf' => '大分類',
    'shelves' => '大分類',
    'x_shelves' => ':count 大分類|:count 大分類',
    'shelves_empty' => '大分類が作成されていません',
    'shelves_create' => '新しい大分類を作成',
    'shelves_popular' => '人気の大分類',
    'shelves_new' => '新しい大分類',
    'shelves_new_action' => '新しい大分類',
    'shelves_popular_empty' => 'ここに人気の大分類が表示されます。',
    'shelves_new_empty' => '最近作成された大分類がここに表示されます。',
    'shelves_save' => '大分類を保存',
    'shelves_books' => 'この大分類の中分類',
    'shelves_add_books' => 'この大分類に中分類を追加',
    'shelves_drag_books' => '下に中分類をドラッグしてこの大分類に追加',
    'shelves_empty_contents' => 'この大分類には中分類が割り当てられていません。',
    'shelves_edit_and_assign' => '大分類を編集して中分類を割り当てる',
    'shelves_edit_named' => '大分類「:name」を編集',
    'shelves_edit' => '大分類を編集',
    'shelves_delete' => '大分類を削除',
    'shelves_delete_named' => '大分類「:name」を削除',
    'shelves_delete_explain' => "これにより、この大分類「:name」が削除されます。含まれている中分類は削除されません。",
    'shelves_delete_confirmation' => '本当にこの大分類を削除してよろしいですか？',
    'shelves_permissions' => '大分類の権限',
    'shelves_permissions_updated' => '大分類の権限を更新しました',
    'shelves_permissions_active' => '大分類の権限は有効です',
    'shelves_permissions_cascade_warning' => '大分類の権限は含まれる本には自動的に継承されません。これは、1つの中分類が複数の大分類に存在する可能性があるためです。ただし、以下のオプションを使用すると権限を子中分類にコピーできます。',
    'shelves_copy_permissions_to_books' => '中分類に権限をコピー',
    'shelves_copy_permissions' => '権限をコピー',
    'shelves_copy_permissions_explain' => 'これにより、この大分類の現在の権限設定を大分類に含まれるすべての中分類に適用します。有効にする前に、この大分類の権限への変更が保存されていることを確認してください。',
    'shelves_copy_permission_success' => '大分類の権限が:count個の中分類にコピーされました',

    // Books
    'book' => '中分類',
    'books' => '中分類',
    'x_books' => ':count 中分類',
    'books_empty' => 'まだ中分類は作成されていません',
    'books_popular' => '人気の中分類',
    'books_recent' => '最近の中分類',
    'books_new' => '新しい中分類',
    'books_new_action' => '新しい中分類',
    'books_popular_empty' => 'ここに人気の中分類が表示されます。',
    'books_new_empty' => '最近作成された中分類がここに表示されます。',
    'books_create' => '新しい中分類を作成',
    'books_delete' => '中分類を削除',
    'books_delete_named' => '中分類「:bookName」を削除',
    'books_delete_explain' => '「:bookName」を削除すると、中分類内のページとチャプターも削除されます。',
    'books_delete_confirmation' => '本当にこの中分類を削除してよろしいですか？',
    'books_edit' => '中分類を編集',
    'books_edit_named' => '中分類「:bookName」を編集',
    'books_form_book_name' => '中分類名',
    'books_save' => '中分類を保存',
    'books_permissions' => '中分類の権限',
    'books_permissions_updated' => '中分類の権限を更新しました',
    'books_empty_contents' => 'まだページまたはチャプターが作成されていません。',
    'books_empty_create_page' => '新しいページを作成',
    'books_empty_sort_current_book' => '中分類の並び順を変更',
    'books_empty_add_chapter' => 'チャプターを追加',
    'books_permissions_active' => '中分類の権限は有効です',
    'books_search_this' => 'この中分類から検索',
    'books_navigation' => '目次',
    'books_sort' => '並び順を変更',
    'books_sort_desc' => '中分類内のチャプターとページを移動して、その内容を再編成します。 他の中分類を追加することで、チャプターやページを中分類間で簡単に移動することができます。',
    'books_sort_named' => '中分類「:bookName」を並べ替え',
    ...
    'books_sort_show_other' => '他の中分類を表示',
    'books_sort_save' => '並び順を保存',
    'books_sort_show_other_desc' => 'これらの中分類を並べ替え操作に追加すると、簡単に中分類間の再編成が可能です。',
    'books_sort_move_up' => '上に移動',
    'books_sort_move_down' => '下に移動',
    'books_sort_move_prev_book' => '前の中分類に移動',
    'books_sort_move_next_book' => '次の中分類に移動',
    ...
    'books_copy' => '中分類をコピー',
    'books_copy_success' => '中分類が正常にコピーされました',
    ...
    'tags_assigned_books' => '割り当てられている中分類の数',
    'tags_assigned_shelves' => '割り当てられている大分類の数',
    'tags_x_unique_values' => ':count個のユニークな値',
    'tags_all_values' => '全ての値',
    'tags_view_tags' => 'タグを表示',
    'tags_view_existing_tags' => '既存のタグを表示',
    'tags_list_empty_hint' => 'タグはページエディタのサイドバーまたは中分類、チャプター、大分類の詳細を編集しているときに割り当てることができます。',
    'attachments' => '添付ファイル',
    ...
    'profile_not_created_books' => ':userNameは中分類を作成していません',
    'profile_not_created_shelves' => ':userNameは大分類を作成していません',
    ...
    // Conversions
    'convert_to_shelf' => '大分類に変換',
    'convert_to_shelf_contents_desc' => 'この中分類を同じ内容の新しい棚に変換できます。この中分類に含まれるチャプターは新しい中分類に変換されます。この中分類にチャプター内にないページが含まれている場合、この中分類は名前が変更され、そのようなページを含む新しい大分類の一部となります。',
    'convert_to_shelf_permissions_desc' => 'この中分類に設定されているすべての権限は、新しい大分類と、独自の権限が適用されていないすべての新しい子中分類にコピーされます。大分類の権限は中分類の場合のように、内部のコンテンツに自動的に継承されないことに注意してください。',
    'convert_book' => '中分類を変換',
    'convert_book_confirm' => 'この中分類を変換してもよろしいですか？',
    'convert_undo_warning' => 'これは簡単には元に戻せません。',
    'convert_to_book' => '中分類に変換',
    'convert_to_book_desc' => 'このチャプターを同じ内容の新しい中分類に変換できます。このチャプターで設定された権限は新しい中分類にコピーされますが、親中分類から継承された権限はコピーされないため、アクセス制御が変更される可能性があります。',
