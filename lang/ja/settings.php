...
return [
    ...
    'maint_recycle_bin_desc' => '削除された大分類・中分類・チャプター・ページはごみ箱に送られるため、復元したり完全に削除したりできます。システムの設定によっては、ごみ箱の古いアイテムがしばらくすると自動的に削除される場合があります。',
    ...
    'role_manage_entity_permissions' => '全ての中分類, チャプター, ページに対する権限の管理',
    'role_manage_own_entity_permissions' => '自身の中分類, チャプター, ページに対する権限の管理',
