...
return [
    ...
    'breadcrumb_siblings_for_page' => 'Navigera mellan syskon för sida',
    'breadcrumb_siblings_for_chapter' => 'Navigera mellan syskon för kapitel',
    'breadcrumb_siblings_for_book' => 'Navigera mellan syskon för bok',
    'breadcrumb_siblings_for_bookshelf' => 'Navigera mellan syskon för hylla',
    ...
    'books_sort_auto_sort_creation_hint' => 'Regler för automatisk sortering kan skapas i inställningsområdet "Listor och sortering" av en användare med relevanta behörigheter.',
    ...
    'pages_edit_switch_to_new_wysiwyg_desc' => '(I betatestning)',
    ...
    'pages_md_sync_scroll' => 'Synkronisera förhandsgranskningsrullning',
    'pages_md_plain_editor' => 'Textredigerare (plaintext)',
    ...
    'pages_pointer_permalink' => 'Permalänk för sidavsnitt',
    'pages_pointer_include_tag' => 'Include-tagg för sidavsnitt',
    'pages_pointer_toggle_link' => 'Permalänksläge, tryck för att visa include-tagg',
    'pages_pointer_toggle_include' => 'Include-taggläge, tryck för att visa permalänk',
    ...
    'page_contents' => 'Sidans innehåll',
    'page_contents_none' => 'Inga rubriker hittades i sidans innehåll.',
    'page_contents_info' => 'Innehållsmenyn genereras utifrån de rubrikformat som används på sidan.',
    'page_tags' => 'Sidtaggar',
    ...
    'attachments_upload_drop' => 'Alternativt kan du dra och släppa en fil här för att ladda upp den som en bilaga.',
    ...
    'comment_thread_count' => ':count kommentarstråd|:count kommentarstrådar',
    'comment_archived_count' => ':count arkiverad(e)',
    'comment_archived_threads' => 'Arkiverade trådar',
    ...
    'comment_unarchive_success' => 'Kommentar avarkiverad',
    ...
    'references_to_desc' => 'Nedan listas allt känt innehåll i systemet som länkar till detta objekt.',

    // Watch Options
    'watch' => 'Följ',
    'watch_title_default' => 'Standardinställningar',
    'watch_desc_default' => 'Återställ bevakning till enbart dina standardaviseringsinställningar.',
    ...
    'watch_title_comments' => 'Alla sidupdateringar och kommentarer',
    ...
    'watch_detail_new' => 'Bevakar nya sidor',
    'watch_detail_updates' => 'Bevakar nya sidor och uppdateringar',
    'watch_detail_comments' => 'Bevakar nya sidor, uppdateringar och kommentarer',
    'watch_detail_parent_book' => 'Bevakar via överordnad bok',
    'watch_detail_parent_book_ignore' => 'Ignorerar via överordnad bok',
    'watch_detail_parent_chapter' => 'Bevakar via överordnat kapitel',
    'watch_detail_parent_chapter_ignore' => 'Ignorerar via överordnat kapitel',
];
