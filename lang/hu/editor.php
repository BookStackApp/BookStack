...
return [
    ...
    'edit_code_block' => 'Kódrészlet szerkesztése',
    'insert_drawing' => 'Rajz beszúrása/szerkesztése',
    'drawing_manager' => 'Rajzkezelő',
    'insert_media' => 'Média beszúrása/szerkesztése',
    'insert_media_title' => 'Média beszúrása/szerkesztése',
    ...
    'table_clear_formatting' => 'Táblázat formázás törlése',
    'resize_to_contents' => 'Átméretezés a tartalomhoz',
    'row_header' => 'Fejléc sor',
    ...
    'cell_padding' => 'Cellamargó',
    'cell_spacing' => 'Cellatávolság',
    'caption' => 'Felirat',
    'show_caption' => 'Felirat megjelenítése',
    ...
    'embed' => 'Beágyazás',
    'paste_embed' => 'Illessze be a beágyazási kódot ide:',
    'url' => 'URL',
    'text_to_display' => 'Megjelenítendő szöveg',
    'title' => 'Cím',
    'browse_links' => 'Hivatkozások tallózása',
    ...
    'insert_collapsible' => 'Összecsukható blokk beszúrása',
    'collapsible_unwrap' => 'Eltávolítás',
    'edit_label' => 'Címke szerkesztése',
    'toggle_open_closed' => 'Nyitott/zárt állapot váltása',
    'collapsible_edit' => 'Összecsukható blokk szerkesztése',
    'toggle_label' => 'Címke ki/be kapcsolása',

    // About view
    'about' => 'A szerkesztő névjegye',
    'about_title' => 'A WYSIWYG szerkesztőről',
    'editor_license' => 'Szerkesztő licenc és jogi információi',
    'editor_lexical_license' => 'Ez a szerkesztő az MIT licenc alatt szolgáltatott :lexicalLink segítségével készült.',
    'editor_lexical_license_link' => 'A teljes licenc az itt található.',
    ...
    'save_continue' => 'Oldal mentése és folytatás',
    'callouts_cycle' => '(Ismételt lenyomással váltogathat a típusok között)',
