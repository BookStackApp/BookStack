...
return [
    ...
    'pages_edit_delete_draft_confirm' => 'آیا مطمئن هستید که می خواهید تغییرات صفحه پیش نویس خود را حذف کنید؟ تمام تغییرات شما، از آخرین ذخیره کامل، از بین می رود و ویرایشگر با آخرین وضعیت ذخیره صفحه بدون پیش نویس به روز می شود.',
    ...
    'pages_drawing_unsaved' => 'شکل ذخیره نشده یافت گردید',
    'pages_drawing_unsaved_confirm' => 'طراحی شکل ذخیره نشده از تلاش های قبلی یافت گردید، آیا قصد بازیابی و ادامه طراحی این شکل ذخیره نشده را دارید؟',
    ...
    'pages_edit_content_link' => 'پرش به بخش در ویرایشگر',
    'pages_pointer_enter_mode' => 'وارد حالت انتخاب بخش شوید',
    'pages_pointer_label' => 'گزینه های بخش صفحه',
    'pages_pointer_permalink' => 'پیوند دائمی بخش صفحه',
    'pages_pointer_include_tag' => 'بخش صفحه شامل برچسب',
    'pages_pointer_toggle_link' => 'حالت پیوند دائمی، برای مشاهده تگ کلیک کنید.',
    'pages_pointer_toggle_include' => 'حالت تگ ها، برای مشاهده پیوندهای دائمی کلیک نمایید.',
    ...
    'pages_draft_discarded' => 'پیش نویس لغو شد! ویرایشگر با محتوای صفحه فعلی به روز شده است',
    ...
    'watch_desc_default' => 'برگشت دادن زیر نظر گرفتن به تنظیمات پیش فرض اعلان.',
    'watch_title_ignore' => 'چشم پوشی',
    'watch_desc_ignore' => 'همه اعلان‌ها، از جمله اعلان‌های مربوط به تنظیمات برگزیده در سطح کاربر را نادیده بگیرید.',
    'watch_title_new' => 'صفحات جدید',
    'watch_desc_new' => 'هنگامی که صفحه جدیدی در این آبتم ایجاد می شود اطلاع دهید.',
    'watch_title_updates' => 'همه به روز رسانی های صفحه',
    'watch_desc_updates' => 'از تمام صفحات جدید و تغییرات صفحه مطلع شوید.',
    'watch_desc_updates_page' => 'از همه تغییرات صفحه مطلع شوید.',
    'watch_title_comments' => 'همه به‌روزرسانی‌ها و نظرات صفحه',
    'watch_desc_comments' => 'از تمام صفحات جدید، تغییرات صفحه و نظرات جدید مطلع شوید.',
    'watch_desc_comments_page' => 'از تغییرات صفحه و نظرات جدید مطلع شوید.',
    'watch_change_default' => 'تنظیمات پیش‌فرض اعلان را تغییر دهید',
    'watch_detail_ignore' => 'چشم پوشی کردن از اعلان ها',
    'watch_detail_new' => 'زیر نظر گرفتن صفحات جدید',
    'watch_detail_updates' => 'زیر نظر گرفتن صفحات جدید و تغییرات',
    'watch_detail_comments' => 'زیر نظر گرفتن صفحات جدید، تغییرات و نظرات',
    'watch_detail_parent_book' => 'زیر نظر گرفتن از طریق کتاب والد',
    'watch_detail_parent_book_ignore' => 'چشم پوشی کردن از طریق کتاب والد',
    'watch_detail_parent_chapter' => 'زیر نظر گرفتن از طریق فصل والد ',
    'watch_detail_parent_chapter_ignore' => 'چشم پوشی کردن از طریق فصل والد',
];
