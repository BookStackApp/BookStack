...
return [
    ...
    'books_sort_auto_sort_creation_hint' => 'قوانین گزینه‌ی مرتب‌سازی خودکار را می‌توان توسط کاربری که دسترسی‌های لازم را دارد، در بخش تنظیمات "فهرست‌ها و مرتب‌سازی" ایجاد کرد.',
    ...
    'page_contents' => 'محتوای صفحه',
    'page_contents_none' => 'هیچ سرتیتری در محتوای صفحه یافت نشد.',
    'page_contents_info' => 'منوی محتوا از هر سرتیتری که در صفحه استفاده شده باشد تولید می شود.',
