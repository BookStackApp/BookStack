...
return [
    ...
    'import_pending' => 'انتقال‌های در انتظار انجام',
    'import_pending_none' => 'هیچ فرآیند انتقالی آغاز نشده است.',
    'import_continue' => 'ادامه فرآیند انتقال',
    ...
    'import_details' => 'جزئیات انتقال',
    'import_run' => 'شروع فرایند انتقال',
    'import_size' => 'حجم فایل ZIP انتقالی',
    'import_uploaded_at' => 'زمان صرف شده برای بارگذاری:',
