...
return [
    ...
    // Revisions
    'revision_restore' => 'بازبینی بازیابی شد',
    'revision_delete'  => 'بازبینی حذف شد',
    ...
    // Watching
    'watch_update_level_notification' => 'تنظیمات زیر نظر گرفتن به روز رسانی گردید',

    // Auth
    'auth_login' => 'وارد شده',
    'auth_register' => 'ثبت نام به عنوان کاربر جدید',
    'auth_password_reset_request' => 'بازیابی رمز کاربر درخواست گردید',
    'auth_password_reset_update' => 'بازیابی رمز کاربر',
    'mfa_setup_method' => 'روش MFA پیکربندی گردید',
    'mfa_setup_method_notification' => 'روش چند فاکتوری با موفقیت پیکربندی شد',
    'mfa_remove_method' => 'روش MFA حذف شد',
    'mfa_remove_method_notification' => 'روش چند فاکتوری با موفقیت حذف شد',

    // Settings
    'settings_update' => 'تنظیمات به روز شد',
    'settings_update_notification' => 'تنظیمات با موفقیت به روز شد',
    'maintenance_action_run' => 'تعمیر و نگهداری اجرا گردید',
