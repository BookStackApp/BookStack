...
return [
    ...
    'notifications_opt_comment_mentions' => 'وقتی که من در یک نظر تگ شده ام اطلاع بده',
    ...
    'profile_desc' => 'علاوه بر جزئیاتی که برای ارتباط و شخصی‌سازی سیستم استفاده می‌شود، جزئیات حساب خود را که نشان دهنده شما برای سایر کاربران است، مدیریت کنید.',
