...
return [
    ...
    'cover_image_description' => 'Ова слика би требало да буде приближно 440х250px иако ће бити флексибилно скалирана и исечена како би одговарала корисничком интерфејсу у различитим сценаријима по потреби, тако да ће се стварне димензије приказа разликовати.',
    ...
    'status_inactive' => 'Неактиван',
    'never' => 'Никад',
    'none' => 'Ништа',
    'move_left' => 'Помери лево',
    'move_right' => 'Помери десно',
    ...
    // OpenSearch
    'opensearch_description' => 'Претражи :appName',
];
