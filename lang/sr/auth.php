...
return [
    ...
    'mfa_option_totp_title' => 'Апликација за мобилне уређаје',
    ...
    'mfa_gen_backup_codes_desc' => 'Сачувајте списак кодова испод на безбедном месту. Када приступате систему, моћи ћете да користите један од кодова као други механизам за аутентификацију.',
