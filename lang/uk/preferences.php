...
return [
    ...
    'notifications_watched_desc' => ' Нижче наведені предмети, які мають застосовані налаштування годинника. Щоб оновити ваші налаштування для них, перегляньте елемент, а потім знайдіть параметри годинника на бічній панелі.',
